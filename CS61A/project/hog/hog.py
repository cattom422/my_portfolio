...
def roll_dice(num_rolls, dice=six_sided):
    ...
    for i in range(num_rolls):
        ...
        sum_dice+=cur_point
        if cur_point==1:
            sow_happen=1#still adding when sow happened
    if sow_happen:
        return 1
    else:
        return sum_dice
...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    return max(1,abs(player_score%10-opponent_score//10%10)*3)#nice
    # END PROBLEM 2
...
def play(strategy0, strategy1, update,
    ...
    while score0<goal and score1<goal:
        ...
        else:#strategy is a function that needs parameters!even always_roll5
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def always(player_score,oppent_score):
        return n
    return always
    # END PROBLEM 6
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    cur_num,cur_score=0,0
    for i in range(10):
        cur_num=i+1
        cur_score=make_averaged(roll_dice,times_called)(cur_num,dice)
